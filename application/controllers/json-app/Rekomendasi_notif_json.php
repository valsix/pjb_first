...
class rekomendasi_notif_json extends CI_Controller
{
	...
	function json_notif()
	{
		...
		if($reqNotif !="")
		{
			$statement .= " AND E.OUTLINING_ASSESSMENT_REKOMENDASI_ID IS NOT NULL  AND E.V_STATUS= ".$reqNotif;
		}
		
		$set= new Notif();

		$sOrder = " ORDER BY C.TAHUN,C.BULAN,C.DISTRIK_ID ASC ";
		$set->selectByParamsRekomendasiNotif(array(), $dsplyRange, $dsplyStart, $statement.$searchJson, $sOrder,$appuserroleid);
