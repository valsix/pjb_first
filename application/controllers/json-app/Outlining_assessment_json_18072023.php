...
class outlining_assessment_json extends CI_Controller
{
	...
	function add()
	{
		...
		if ($reqMode == "insert")
		{
			...
			$statement=" AND A.BULAN =  '".$reqBulan."'  AND A.TAHUN =  '".$reqTahun."'  AND A.DISTRIK_ID =  '".$reqDistrikId."'  AND A.BLOK_UNIT_ID =  '".$reqBlokId."' AND A.UNIT_MESIN_ID =  '".$reqUnitMesinId."' ";
			...
			if(!empty($checkKode))
			{
				echo "xxx***Data sudah ada untuk periode ini ";exit;	
			}
