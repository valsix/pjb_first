...
$link="template/import/konfirmasi_item_assessment.xls";
?>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/konfirmasi_item',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/master_konfirmasi_item_assessment";
                });
        }
    });
}
