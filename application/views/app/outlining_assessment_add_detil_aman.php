...
<script type="text/javascript">
    ...
    function AddRekomendasi(reqAreaDetilId,reqDetilId,reqId)
    {
        ...
        window.open('app/index/outlining_assessment_add_rekomendasi?reqAreaDetilId='+reqAreaDetilId+'&reqDetilId='+reqDetilId+'&reqId='+reqId+'&reqKembali=1&reqPage=1', '_self'); 
    } 
