...
<script type="text/javascript">
    ...
    var valinfoid= valinforowid= valinfostatus=valinfoareadetilid=valinfodetilid=valinforeqid='';
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/outlining_assessment_rekomendasi?reqAreaDetilId="+valinfoareadetilid+"&reqDetilId="+valinforeqid+"&reqId="+valinforeqid+"&reqKembali=1&reqPage=4&reqRekomendasi="+valinfoid;
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/rekomendasi_notif_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
     ...
     $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/rekomendasi_notif_json/delete/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/rekomendasi_notif_json/json?reqPencarian="+reqPencarian+"&reqDistrikId="+reqDistrik+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/rekomendasi_notif_json/json_notif?reqNotif=<?=$reqNotif?>";
