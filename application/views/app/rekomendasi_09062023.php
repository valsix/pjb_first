...
$arrtabledata= array(
    ...
    , array("label"=>"Area", "field"=> "AREA_INFO", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Nama Di Unit", "field"=> "NAMA_INFO", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"Keterangan", "field"=> "KETERANGAN", "display"=>"",  "width"=>"20", "colspan"=>"", "rowspan"=>"")
    // , array("label"=>"Rekomendasi", "field"=> "REKOMENDASI", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    // , array("label"=>"Jenis Rekomendasi", "field"=> "JENIS_INFO", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    // , array("label"=>"Prioritas Rekomendasi", "field"=> "PRIORITAS_INFO", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    // , array("label"=>"Kategori Rekomendasi", "field"=> "KATEGORI_INFO", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"fieldid", "field"=> "OUTLINING_ASSESSMENT_AREA_DETIL_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    , array("label"=>"fieldid", "field"=> "ITEM_ASSESSMENT_DUPLIKAT_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
...
<script type="text/javascript">
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/outlining_assessment_add_rekomendasi?reqLihat=1&reqAreaDetilId="+valinfoareadetilid+"&reqDetilId="+valinfodetilid+"&reqId="+valinfooutid+"&reqListAreaId="+valinfolistareaid+"&reqItemAssessmentDuplikatId="+valinfoduplikatid+"&reqTahun="+valinfotahun;
        document.location.href = varurl;
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('program',pesan,function(r){
            if (r){
                $.getJSON("json-app/rekomendasi_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
    ...
    $('#btnDeleteNew').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/rekomendasi_json/delete/?reqId="+valinfoid,
                    function(data){
                        $.messager.alert('Info', data.PESAN, 'info');
                        valinfoid= "";
                        setCariInfo();
    ...
    $(document).ready(function() {
        ...
        $('#example tbody').on( 'click', 'tr', function () {
            if ( $(this).hasClass('selected') ) {
                ...
                fieldinfooutid= arrdata[indexfieldoutid]["field"];
                fieldinfolistareaid= arrdata[indexfieldlistareaid]["field"];
                fieldinfoduplikatid= arrdata[indexfieldduplikatid]["field"];
                ...
                valinfooutid= dataselected[fieldinfooutid];
                valinfolistareaid= dataselected[fieldinfolistareaid];
                valinfoduplikatid= dataselected[fieldinfoduplikatid];
                valinfotahun= dataselected[fieldinfotahun];
                valinfoareadetilid= dataselected[fieldinfoareadetilid];

                // console.log(valinfolistareaid);
