...
else
{
    ...
    $statement=" AND A.STATUS IS NULL AND A.LIST_AREA_ID =".$reqListAreaId;
    $set->selectByParams(array(), -1,-1,$statement);
    // echo $set->query;exit;
    while($set->nextRow())
    {
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <!-- <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                    <select class="form-control jscaribasicmultiple" required id="reqListAreaId" <?=$disabled?> name="reqListAreaId"  style="width:100%;" >
                                        <?/*
                    ...
                    <div class="form-group">  
                        <label class="control-label col-md-2">Tersedia di Unit ? </label>
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
...
$('#reqDistrikId').on('change', function() {
    $("#blok").empty();
   // $.ajax({
   //    url: "json-app/distrik_json/getHirarki",
   //    type: "POST",
   //    data: {reqDistrikId : this.value},
   //    dataType: "json",
   //    cache: false,
   ...
   //     }
   //  });
    $.get("app/loadUrl/app/blok_unit_template?reqDistrikId="+this.value, function(data) { 
        $("#blok").append(data);
    });

    $("#unit").empty();
    $.get("app/loadUrl/app/unit_mesin_template?reqDistrikId="+this.value, function(data) { 
        $("#unit").append(data);
    });
});
