...
$('#reqBulan,#reqTahun').on('change', function() {
    ...
    function(data){
        ...
        // console.log();
         $('#distrikm').append("<tr class='distrik'><td style='display: none'>"+entry.DISTRIK_ID+"</td><td style='display: none'>"+entry.BLOK_UNIT_ID+"</td><td style='display: none'>"+entry.OUTLINING_ASSESSMENT_ID+"</td><td><label style='font-weight: normal !important;'>"+entry.DISTRIK_NAMA+"</label></td><td><label style='font-weight: normal !important;'>"+entry.BLOK_NAMA+"</label></td><td>"+entry.STATUS+"</td><td>"+entry.PERC_AREA+" %</td></tr>");
       });
    });
});
...
$(function() {
    ...
    // $('tr').dblclick(function(){
        ...
        {
            window.open('app/index/outlining_assessment_add_rekomendasi?reqAreaDetilId='+reqAreaDetilId+'&reqDetilId='+reqDetilId+'&reqId='+reqId+'&reqKembali=1&reqPage='+reqPage+'&reqDistrikId='+reqDistrikId+'&reqBlokId='+reqBlokId+'&reqAreaDuplikatId='+reqAreaDuplikatId+'&reqAreaId='+reqAreaId, '_self'); 
        }
