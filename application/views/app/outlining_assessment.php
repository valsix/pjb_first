...
$arrtabledata= array(
    ...
    , array("label"=>"Status Approval", "field"=> "STATUS_APPROVAL", "display"=>"",  "width"=>"30", "colspan"=>"", "rowspan"=>"")
...
<script type="text/javascript">
  ...
  $('#reqBulan,#reqTahun,#reqDistrik,#reqBlok,#reqUnitMesin,reqStatus').on('change', function() {
    var reqBulan=$("#reqBulan").val();
    var reqTahun=$("#reqTahun").val();
    var reqDistrik=$("#reqDistrik").val();
    var reqBlok=$("#reqBlok").val();
    var reqStatus=$("#reqStatus").val();
    var reqUnitMesin=$("#reqUnitMesin").val();
    var reqPencarian= $('#example_filter input').val();
    if (reqUnitMesin==null){
        reqUnitMesin='';
    }
    // console.log(bulan);
    // $("#distrikm").empty();
