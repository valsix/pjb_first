...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_area_unit_add?reqId="+valinfoid;
	...
	$('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/area_unit_json/json?reqPencarian="+reqPencarian+"&reqDistrikId="+reqDistrikId+"&reqStatus="+reqStatus+"&reqArea="+reqArea+"&reqPerusahaanId="+reqPerusahaanId;
