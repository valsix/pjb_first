...
$reqJumlahArea = $this->input->get("reqJumlahArea");



$link="app/loadUrl/app/area_unit_template?reqId=".$reqId;
                         ...
                         <div class="card-body">
                            <div class="warning box" style="text-align: justify;font-size: 18px">
                                <ol>
                                    ...
                                    <li>Kolom <b>Status</b> diisi dengan format <b>angka</b> yaitu <b>1</b> atau <b>0</b> 
                                    </li>
                                    <li><b>1</b> untuk status <b>Aktif</b> dan <b>0</b> untuk <b>Tidak Aktif</b>
                                    </li>
                                </ol>
                            </div>
...
function submitForm(){
    $('#ff').form('submit',{
        url:'json-app/import_json/area_unit_template',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alert('Info', infoSimpan ,null,function(){
                    top.location.href= "app/index/master_area_unit_add?reqId=<?=$reqId?>&reqDistrikId=<?=$reqDistrikId?>&reqBlok=<?=$reqBlok?>&reqUnitMesin=<?=$reqUnitMesin?>";
                });
        }
    });
}
