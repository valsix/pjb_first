                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-3'>
                                    <select name="reqBulan" id="reqBulan"  <?=$disabled?>   class="form-control datatable-input">
                                ...
                                <div class='col-md-3'>
                                    <select name="reqTahun" id="reqTahun"  <?=$disabled?>   class="form-control datatable-input">
                                        <option value="">Semua</option>
                                        <?
...
function addmultiarea(id,iddpl, multiinfonama, IDFIELD) 
{
    batas= id.length;

    if(batas > 0)
    {
        rekursivemultiarea(0, id,iddpl, multiinfonama, IDFIELD);
    }
}

function rekursivemultiarea(index, id,iddpl, multiinfonama, IDFIELD) 
{
            ...
            $.ajax({
                ...
                data: {
                    ...
                    success: function (response) {
                        ...
                        rekursivemultiarea(index,id,iddpl, multiinfonama, IDFIELD);
                    },
