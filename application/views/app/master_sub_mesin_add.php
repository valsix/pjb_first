...
else
{
    ...
    $statement = " AND SUB_MESIN_ID = '".$reqId."' ";
    $set->selectByParams(array(), -1, -1, $statement);
    // echo $set->query;exit;
    $set->firstRow();
    $reqId= $set->getField("SUB_MESIN_ID");
...
<div class="col-md-12">
  ...
  <div class="judul-halaman"> <a href="app/index/<?=$pgreturn?>?reqDistrikId=<?=$reqDistrikId?>&reqBlokUnitId=<?=$reqBlokUnitId?>">Data Sub Mesin <?=$reqUnitNama?></a> &rsaquo; Kelola Sub Mesin</div>
    ...
    <div class="konten-area">
        <div class="konten-inner">
                    <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                        ...
                        <div class="form-group">  
                            <label class="control-label col-md-2">Unit Nama</label>
                            <div class='col-md-8'>
                                <div class='form-group'>
                                    <div class='col-md-11'>
                                         <input autocomplete="off" class="easyui-validatebox textbox form-control" type="text" name="reqUnitNama"  id="reqUnitNama" value="<?=$reqUnitNama?>"  disabled style="width:100%" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
function submitForm(){
    ...
    $('#ff').form('submit',{
        url:'json-app/sub_mesin_json/add',
        onSubmit:function(){
        ...
        success:function(data){
            ...
            if(reqId == 'xxx')
                ...
                $.messager.alertLink('Info', infoSimpan, 'info', "app/index/<?=$pgreturn?>?reqBlokUnitId=<?=$reqBlokUnitId?>&reqDistrikId=<?=$reqDistrikId?>&reqUnitMesinId=<?=$reqUnitMesinId?>");
        }
    });
}
