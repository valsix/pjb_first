                        ...
                        <table id="" class="table table-bordered table-striped table-hovered" style="width: 100%;" >
                            <thead >
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 20%" >Upload Lampiran</th>
...
<script type="text/javascript">
    ...
    function AddRekomendasi(reqAreaDetilId,reqDetilId,reqId)
    {
        ...
        window.open('app/index/outlining_assessment_rekomendasi?reqAreaDetilId='+reqAreaDetilId+'&reqDetilId='+reqDetilId+'&reqId='+reqId+'&reqKembali=1&reqPage=4&reqRekomendasi=', '_self'); 
    } 
