    ...
    <div class="konten-area" style="padding: 15px 8px;float:left;width:3000px;background-color: white" >
            <div class="row">
                    <div class="col-sm-4 col-lg-2 " style="padding: 0px 7px !important; height: fit-content;">
                        <span > <button class="btn btn-success btn-sm" onclick="btnCetakPng('ctkjumlahitem')">Download Png</button></span>
                    ...
                    <div class="col-sm-4 col-lg-2" style="padding: 0px 7px !important; height: fit-content">
                        <span > <button class="btn btn-success btn-sm" onclick="btnCetakPng('ctkrekap')">Download Png</button></span>
                        <div style="text-align: center; ">
                    ...
                    <div class="col-sm-4 col-lg-2" style="padding: 0px 7px !important; height: fit-content">
                        <span > <button class="btn btn-success btn-sm" onclick="btnCetakPng('ctkmatriks')">Download Png</button></span>
                                                ...
                                                <div style='position:relative;height:75px;width:75px; vertical-align:middle; text-align:center;padding:30px 0px;'><?=$value["RISIKO"]?>
                                                    <div style='position:absolute;top:5px;right:5px;'>
                                                        ...
                                                        if( in_array( $value["KODE"] ,array_column($arrrekap, 'RISIKO_KODE') ) )
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <div style="font-size: 10px;width:17px;height:17px;float:left;padding:1px;margin:2px;background-color:#fff;border:1px solid black;color:black;" class="dot"><?=$valuex["NO"]?>
                                                                </div>
                                                                <?
                                                            }
                                                        }
    ...
    function btnCetakPng(id)
    {
        ...
        html2canvas(captureElement, {
          ...
          return canvas;
            ...
            a.setAttribute('download', 'hasil_assessment.png');
