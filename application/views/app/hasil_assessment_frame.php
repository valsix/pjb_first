...
<script type="text/javascript">
    ...
    $('#btnCari').on('click', function () {
        ...
        $.getJSON("json-app/hasil_assessment_json/jumlahitem?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekapmatrik?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekaptingkat?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekapkategori?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekapjenis?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekapprioritas?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus,
            function(data)
            {
        ...
        $.get("app/loadUrl/app/hasil_proyeksi?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus, function(data){
    ...
    function getvaluetingkat(reqDistrikId,reqBlok,reqTahun,reqStatus){
       var reqDistrikId= reqBlok=reqTahun=reqStatus="";
       var reqTahun=$("#reqTahun").val();
       var reqStatus=$("#reqStatus").val();
       var reqDistrikId=$("#reqDistrik").val();
       var reqBlok=$("#reqBlok").val();
        $.post( 'json-app/hasil_assessment_json/grafik_tingkat?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus,{}, function(data) {
    ...
    function getvaluejenis(reqDistrikId,reqBlok,reqTahun,reqStatus){
        var reqDistrikId= reqBlok=reqTahun=reqStatus="";
        var reqTahun=$("#reqTahun").val();
        var reqStatus=$("#reqStatus").val();
        var reqDistrikId=$("#reqDistrik").val();
        var reqBlok=$("#reqBlok").val();
        $.post( 'json-app/hasil_assessment_json/grafik_jenis_rekomendasi?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus,{}, function(data) {
                // console.log(data);return false;
            var object= JSON.parse(data);
    ...
    function getvaluerekomendasi(reqDistrikId,reqBlok,reqTahun,reqStatus){
        var reqDistrikId= reqBlok=reqTahun=reqStatus="";
        var reqTahun=$("#reqTahun").val();
        var reqStatus=$("#reqStatus").val();
        var reqDistrikId=$("#reqDistrik").val();
        var reqBlok=$("#reqBlok").val();
        $.post( 'json-app/hasil_assessment_json/grafik_kategori_rekomendasi?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus,{}, function(data) {
                // console.log(data);return false;
            var object= JSON.parse(data);
    ...
    function getvalueprioritas(reqDistrikId,reqBlok,reqTahun,reqStatus){
        var reqDistrikId= reqBlok=reqTahun=reqStatus="";
        var reqTahun=$("#reqTahun").val();
        var reqStatus=$("#reqStatus").val();
        var reqDistrikId=$("#reqDistrik").val();
        var reqBlok=$("#reqBlok").val();
        $.post( 'json-app/hasil_assessment_json/grafik_prioritas_rekomendasi?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus,{}, function(data) {
                // console.log(data);return false;
            var object= JSON.parse(data);
    ...
    function getvaluekesesuaian(reqDistrikId,reqBlok,reqTahun,reqStatus){
        var reqDistrikId= reqBlok=reqTahun=reqStatus="";
        var reqTahun=$("#reqTahun").val();
        var reqStatus=$("#reqStatus").val();
        var reqDistrikId=$("#reqDistrik").val();
        var reqBlok=$("#reqBlok").val();
        $.post( 'json-app/hasil_assessment_json/grafik_kesesuaian?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus,{}, function(data) {
                // console.log(data);return false;
            var object= JSON.parse(data);
            // console.log(obj);
