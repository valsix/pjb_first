            ...
            <div class="col-md-9 col-treegrid">
               ...
               <!--  <div id="tableContainer" class="tableContainer tableContainer-treegrid">
                    <table id="treeSatker" class="easyui-treegrid" style="min-width:100px !important;height:300px"
                            data-options="
                                url: 'json-app/area_json/area_popup?reqId=<?=$reqId?>',
                                pagination: true, 
                                method: 'get',
                                idField: 'id',
                                treeField: 'text',
                ...
                <div id="tableContainer" class="tableContainer tableContainer-treegrid">
                    <table id="treeSatker" class="easyui-treegrid" style="min-width:100px !important;height:300px"
                            data-options="
                                url: 'json-app/area_json/area_duplikat_popup?reqId=<?=$reqId?>',
                                pagination: true, 
                                method: 'get',
                                idField: 'id',
                                treeField: 'text',
...
function formatcheckbox(val,row)
{
    // return "<input type='checkbox' onclick=show('"+row.LIST_AREA_ID+'_'+row.KODE_DUPLIKAT+"') id='check_"+row.LIST_AREA_ID+'_'+row.KODE_DUPLIKAT+"' "+(row.checked?'checked':'')+"/> " + row.text;
     return "<input type='checkbox' onclick=show('"+row.LIST_AREA_ID+"') id='check_"+row.LIST_AREA_ID+"' "+(row.checked?'checked':'')+"/> " + row.text;
...
$(document).ready( function () {     
    ...
    $('input[name=reqPencarian]').keyup(function(e) {
        ...
        if(e.keyCode == 13) {
            var urlApp = 'json-app/area_json/area_popup/?reqPencarian='+value;
            $('#treeSatker').treegrid(
            {
                url: urlApp,
