...
while($set->nextRow())
{
    ...
    $arrdata["NO"]= $no;
    // $arrdata["AREA_NAMA"]= $set->getField("KODE_INFO")." - ".$set->getField("NAMA");
    $arrdata["AREA_NAMA"]= $set->getField("NAMA");
    $arrdata["AREA_UNIT"]= $set->getField("AREA_UNIT");
    $arrdata["NAMA"]= $set->getField("NAMA");
    $arrdata["JUMLAH_KLAUSUL"]= $set->getField("JUMLAH_KLAUSUL");
...
<div class="col-md-12 konten-area divfilter "  >   
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <select name="reqListAreaId"  id="reqListAreaId" class="form-control jscaribasicmultiple" multiple>
                <!-- <option value="" selected="selected">Semua Area</option> -->
                <?
...
<div class="col-md-12">
    <div class="konten-area" style="padding: 15px 8px;background-color: white" >
            <div class="row">
                    <div class="col-sm-4 col-lg-6 " style="padding: 0px 7px !important; ">
                        <div id="divmatrix" style="text-align: left; width:100%;">
                    ...
                    <div class="col-sm-4 col-lg-6" style="padding: 0px 7px !important;">
                        ...
                        <div style="text-align: center; margin-top: 10px;position: inherit; ">
                            <div id="ctkmatriks" style="text-align: left; width:100%;">
                                <div class="page-header" style="background-color: green;width:100%;">
                                    <h3><i class="fa fa-file-text fa-lg"></i> Rekapitulasi Matriks Risiko</h3>      
                                </div>
                                <br>
                                <table class="tbmatrix" id="rmatriksrisiko" style="width:100%;">
                                    <tr> 
                    ...
                    <div class="col-sm-4 col-lg-6" style="padding: 0px 7px !important;margin-top: 30px">
                        <div style="text-align: center; position: inherit; ">
                            <div id="divmatrix" style="text-align: left; width:100%;">
                                ...
                                <div class="area-konten" style="">
                                    <div id="pie-rekomendasi" style=" height: 100%; margin: 0 auto"></div>
                                </div> 
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-lg-6 " style="padding: 0px 7px !important; ">
                        ...
                        <br>
                        <div class="page-header" style="background-color: green;width:100%;">
                            <h3><i class="fa fa-file-text fa-lg"></i> Prioritas Rekomendasi </h3>      
                        </div>
                    ...
                    <div class="col-sm-4 col-lg-6 " style="padding: 0px 7px !important;margin-top: 30px ">
                      <div style="text-align: center; position: inherit; ">
                            ...
                            <div id="divmatrix" style="text-align: left; width:100%;">
                                <div class="page-header" style="background-color: green;width:100%;">
                                    <h3><i class="fa fa-file-text fa-lg"></i>Jumlah Prioritas Rekomendasi </h3>     
                                </div>
                                <div class="judul" style="text-align: center;"></div>
                                <div class="area-konten" style="">
                                    <div id="pie-prioritas" style=" height: 100%;margin: 0 auto"></div>
                                </div>    
                                <br> 
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 col-lg-6 " style="padding: 0px 7px !important; ">
                        ...
                        <br>
                        <div class="page-header" style="background-color: green;width:100%;">
                            <h3><i class="fa fa-file-text fa-lg"></i> Jenis Rekomendasi </h3>      
                        </div>
                    ...
                    <div class="col-sm-4 col-lg-6 " style="padding: 0px 7px !important;margin-top: 30px ">
                        ...
                        <div class="judul" style="text-align: center;"></div>
                        <div class="area-konten" style="font-family: 'helvetica'">
                            <div id="pie-jenisrekomendasi" style=" height: 300px; margin: 0 auto;"></div>
                        </div> 
                    </div>

                    <div class="col-sm-4 col-lg-6 " style="padding: 0px 7px !important;display: none ">
                    ...
                    <div class="col-sm-2 col-lg-6" style="padding: 0px 7px !important;">
                        <br>
...
<script type="text/javascript">
    ...
    $('#btnCari').on('click', function () {
        var reqDistrikId= reqBlok=reqTahun=reqStatus=reqListAreaId=reqBulan="";
        ...
        $.getJSON("json-app/hasil_assessment_json/jumlahitem?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekapmatrik?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekaptingkat?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekapkategori?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekapjenis?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,
            function(data)
            {
        ...
        $.getJSON("json-app/hasil_assessment_json/rekapprioritas?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,
            function(data)
            {
        ...
        $.get("app/loadUrl/app/hasil_proyeksi?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan, function(data){
           $("#rekapproyeksi tr td").remove();           
           // $("#rekapproyeksi").html(data);
           $('#rekapproyeksi tr:last').after(data);
        });

        $.get("app/loadUrl/app/hasil_matriks?reqDistrikId="+reqDistrikId+"&reqBlok="+reqBlok+"&reqTahun="+reqTahun+"&reqStatus="+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan, function(data){
    ...
    function getvaluetingkat(reqDistrikId,reqBlok,reqTahun,reqStatus,reqListAreaId,reqBulan){
       var reqDistrikId= reqBlok=reqTahun=reqStatus=reqListAreaId=reqBulan="";
       var reqTahun=$("#reqTahun").val();
       var reqStatus=$("#reqStatus").val();
       var reqDistrikId=$("#reqDistrik").val();
       ...
       var reqBulan=$("#reqBulan").val();
        ...
        $.post( 'json-app/hasil_assessment_json/grafik_tingkat?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,{}, function(data) {
    ...
    function getvaluejenis(reqDistrikId,reqBlok,reqTahun,reqStatus,reqListAreaId,reqBulan){
        ...
        $.post( 'json-app/hasil_assessment_json/grafik_jenis_rekomendasi?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,{}, function(data) {
                // console.log(data);return false;
            var object= JSON.parse(data);
    ...
    function getvaluerekomendasi(reqDistrikId,reqBlok,reqTahun,reqStatus,reqListAreaId,reqBulan){
        var reqDistrikId= reqBlok=reqTahun=reqStatus=reqListAreaId="";
        var reqTahun=$("#reqTahun").val();
        var reqStatus=$("#reqStatus").val();
        var reqDistrikId=$("#reqDistrik").val();
        ...
        $.post( 'json-app/hasil_assessment_json/grafik_kategori_rekomendasi?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,{}, function(data) {
                // console.log(data);return false;
            var object= JSON.parse(data);
    ...
    function getvalueprioritas(reqDistrikId,reqBlok,reqTahun,reqStatus,reqListAreaId,reqBulan){
        var reqDistrikId= reqBlok=reqTahun=reqStatus=reqListAreaId="";
        var reqTahun=$("#reqTahun").val();
        var reqStatus=$("#reqStatus").val();
        var reqDistrikId=$("#reqDistrik").val();
        ...
        $.post( 'json-app/hasil_assessment_json/grafik_prioritas_rekomendasi?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,{}, function(data) {
                // console.log(data);return false;
            var object= JSON.parse(data);
    ...
    function getvaluekesesuaian(reqDistrikId,reqBlok,reqTahun,reqStatus,reqListAreaId,reqBulan){
        var reqDistrikId= reqBlok=reqTahun=reqStatus=reqListAreaId="";
        var reqTahun=$("#reqTahun").val();
        var reqStatus=$("#reqStatus").val();
        var reqDistrikId=$("#reqDistrik").val();
        ...
        $.post( 'json-app/hasil_assessment_json/grafik_kesesuaian?reqDistrikId='+reqDistrikId+'&reqBlok='+reqBlok+'&reqTahun='+reqTahun+'&reqStatus='+reqStatus+"&reqListAreaId="+reqListAreaId+"&reqBulan="+reqBulan,{}, function(data) {
                // console.log(data);return false;
            var object= JSON.parse(data);
            // console.log(obj);
    ...
    function ubahvaluekesesuaian(object){
        ...
        $.each(object,function(key,value){
            arrCategories.push(value.AREA_UNIT);
