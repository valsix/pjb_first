...
$(function() {
    ...
    // $('tr').dblclick(function(){
        ...
        {
            window.open('app/index/outlining_assessment_add_rekomendasi?reqAreaDetilId='+reqAreaDetilId+'&reqDetilId='+reqDetilId+'&reqId='+reqId+'&reqKembali=1&reqPage='+reqPage+'&reqDistrikId='+reqDistrikId+'&reqBlokId='+reqBlokId+'&reqAreaDuplikatId='+reqAreaDuplikatId+'&reqAreaId='+reqAreaId+'&reqRekomendasiId='+reqRekomendasiId, '_self'); 
        }
