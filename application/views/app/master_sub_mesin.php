...
$arrtabledata= array(
    ...
    , array("label"=>"Unit Mesin ", "field"=> "MESIN_NAMA", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
    ...
    , array("label"=>"fieldid", "field"=> "SUB_MESIN_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
...
$statement = " AND UNIT_MESIN_ID = '".$reqUnitMesinId."' ";
$set->selectByParams(array(), -1, -1, $statement);
    // echo $set->query;exit;
$set->firstRow();
$reqUnitNama= $set->getField("NAMA");
...
<div class="col-md-12">
    <div class="judul-halaman"> Data Blok/Unit <?=$reqNama?> <?=$reqBlokNama?> <?=$reqUnitNama?></div>
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_sub_mesin_add?reqId="+valinfoid+"&reqDistrikId=<?=$reqDistrikId?>&reqBlokUnitId=<?=$reqBlokUnitId?>&reqUnitMesinId=<?=$reqUnitMesinId?>";
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_sub_mesin_add?reqId="+valinfoid+"&reqLihat=1"+"&reqDistrikId=<?=$reqDistrikId?>&reqBlokUnitId=<?=$reqBlokUnitId?>&reqUnitMesinId=<?=$reqUnitMesinId?>";;
        document.location.href = varurl;
    });
    ...
    $('#btnDelete').on('click', function () {
        ...
        $.messager.confirm('Konfirmasi',pesan,function(r){
            if (r){
                $.getJSON("json-app/sub_mesin_json/update_status/?reqId="+valinfoid+"&reqStatus="+reqStatus,
                    function(data){
    ...
    $('#btnImport').on('click', function () {
        openAdd("app/index/master_sub_mesin_import");
    });

	$('#btnCari').on('click', function () {
		reqPencarian= $('#example_filter input').val();

        jsonurl= "json-app/sub_mesin_json/json?reqPencarian="+reqPencarian;
	...
	jQuery(document).ready(function() {
		var jsonurl= "json-app/sub_mesin_json/json?reqDistrikId=<?=$reqDistrikId?>&reqBlokUnitId=<?=$reqBlokUnitId?>&reqUnitMesinId=<?=$reqUnitMesinId?>";
