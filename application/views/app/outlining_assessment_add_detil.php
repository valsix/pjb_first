        ...
        <div class="konten-inner">
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    ?>
                        <table id="" class="table table-bordered table-striped table-hovered" style="width: 100%;<?=$tablefixed?>" >
                            <thead >
                                <tr>
                                    <th class="text-center" style="vertical-align: middle;width: 5%;">No</th>
                                    <th class="text-center" style="vertical-align: middle;width: 11%;">Item Assesment</th>
                                    <th class="text-center" style="vertical-align: middle;width: 20%;">Referensi Standar</th>
                                    <th class="text-center" style="width: 15%;vertical-align: middle;<?=$displayall?>">Konfirmasi</th>
                                    <th class="text-center" style="width: 15%;vertical-align: middle;<?=$displayall?>">Program Item Assessment</th>
                                    <th class="text-center" style="vertical-align: middle;width: 10%;">Confirm</th>
                                    <th class="text-center" style="vertical-align: middle;width: 10%;">Not Confirm</th>
                                    <th class="text-center" style="vertical-align: middle;width: 35%;">Keterangan</th>
                                    <th class="text-center" style="width: 15%;vertical-align: middle;<?=$displayall?>">Kategori item Assessment</th>
                                    <th class="text-center" style="width: 15%;vertical-align: middle;<?=$displayall?>">Bobot</th>
                                    <th class="text-center" style="width: 15%;vertical-align: middle;<?=$displayall?>">Total Bobot</th>
                                    <th class="text-center" style="width: 15%;vertical-align: middle;<?=$displayall?>">Nilai Total</th>
                                    <th class="text-center" style="width: 15%;vertical-align: middle;<?=$displayall?>">Dampak</th>
                                    <th class="text-center" style="width: 15%;vertical-align: middle;<?=$displayall?>">Kemungkinan</th>
                                    <th class="text-center" style="width: 27%;vertical-align: middle;" >Upload Lampiran</th>
                                    <th class="text-center" style="width: 14%;vertical-align: middle;" id="rekom" >Rekomendasi</th>
                                </tr>
                            </thead>
                            <tbody id="outlinedetil">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="vertical-align:middle;text-align: center"><input type="radio" name="reqConfirm[<?=$reqUniqId?>]" <?=$disabled?> id="reqConfirm<?=$reqUniqId?>" <? if($reqConfirm=="1") echo 'checked';?> value="1"></td>
                                        <td style="vertical-align:middle;text-align: center"><input type="radio" name="reqConfirm[<?=$reqUniqId?>]" <?=$disabled?> id="reqConfirm<?=$reqUniqId?>" <? if($reqConfirm=="0") echo 'checked';?> value="0"></td>
                                        <td>  
                                            <textarea  class="easyui-validatebox textbox form-control" style="width:100%;"  name="reqKeterangan[]" <?=$disabled?>  id="reqKeterangan"><?=$reqKeterangan?></textarea>
                                        </td>
