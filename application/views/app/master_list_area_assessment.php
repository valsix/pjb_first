    ...
    <div class="konten-area">
       ...
       <!--  <div class="area-filter">
        ...
        z-index: 10;clear: both;display: none">
            ...
            <div class="divfilter filterbaru" style=""  >
...
<script type="text/javascript">
	...
	$("#btnAdd, #btnEdit").on("click", function () {
        ...
        varurl= "app/index/master_list_area_assessment_add?reqId="+valinfoid;
    ...
    $("#btnLihat").on("click", function () {
        ...
        varurl= "app/index/master_list_area_assessment_add?reqId="+valinfoid+"&reqLihat=1";
        document.location.href = varurl;
    });
