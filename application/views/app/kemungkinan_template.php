...
$objPHPexcel = PHPExcel_IOFactory::load('template/export/kemungkinan.xlsx');
...
$objWorksheet->setCellValue("A1","Peraturan Id");
...
$field= array();
$field= array("PERATURAN_ID","NAMA");

$statement=" AND A.STATUS IS NULL";

$set = new Peraturan();
$sOrder=" ORDER BY PERATURAN_ID ASC ";
...
$objWriter->save('template/import/kemungkinan.xls');

$down = 'template/import/kemungkinan.xls';
