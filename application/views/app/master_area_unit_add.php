        ...
        <div class="konten-inner">
            ...
            ?>
                ...
                <div style="text-align:center;padding:5px">
                    ...
                    {
                        ?>
                        <a href="javascript:void(0)" class="btn btn-danger" onclick="deleteform('<?=$reqId?>')">Hapus</a>
                         <?
                }
                ?>
                </div>
...
function deleteform(reqId){
    if(reqId == "" )
    {
        return false;
    }

    var pesan='Apakah anda yakin untuk hapus data ini?';

    $.messager.confirm('Konfirmasi',pesan,function(r){
        if (r){
            $.getJSON("json-app/area_unit_json/delete/?reqId="+reqId,
                function(data){
