...
else
{
    ...
    while($setdetil->nextRow())
    {
        ...
        $arrdata["PROGRAM_ITEM_ASSESSMENT_ID"]= $setdetil->getField("PROGRAM_ITEM_ASSESSMENT_ID");
        $arrdata["STATUS_KONFIRMASI"]= $setdetil->getField("STATUS_KONFIRMASI");
        $arrdata["BOBOT"]= $setdetil->getField("BOBOT");
                        ...
                        <table id="" class="table table-bordered table-striped table-hovered" style="width: 100%;" >
                            <thead >
                                <tr>
                                    ...
                                    <th class="text-center">Program Item Assessment</th>
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <select  readonly class="form-control " name="reqProgramId[]" required id="reqProgramId<?=$reqUniqId?>" <?=$disabled?>  style="width:100%;" >
                                                    <?
                                            ...
                                            <td>  
                                                <input class="easyui-validatebox textbox form-control" type="text" name="reqBobot[]" id="reqBobot<?=$reqUniqId?>" readonly  value="<?=$reqBobot?>" style="width: 70px" >
                                            </td>
        ...
        $.getJSON("json-app/outlining_assessment_json/filter_standar?reqListAreaId="+reqListAreaId+"&reqKategoriItemAssessmentId="+reqKategoriItemAssessmentId+"&reqFormulirId="+reqFormulirId,
            function(datax)
            {
                ...
                jQuery(datax).each(function(x, itemx){
                    ...
                    $("#reqTersedia"+idx).val(itemx.STATUS_KONFIRMASI).change();
                    $("#reqProgramId"+idx).val(itemx.PROGRAM_ITEM_ASSESSMENT_ID).change();
                    
                });
                $('.deskripsiselect'+idx).select2();
            });
