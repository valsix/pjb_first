...
$unitpengguna= $foto->getField("UNIT");
              ...
              <div class="card shadow-sm">
                ...
                <div class="card-body pt-0">
                  <table class="table table-bordered">
                    ...
                    ?>
                      <tr>
                        <th width="30%"> Role Akses Unit</th>
                        <td width="2%">:</td>
                        <td><?=$alldis?></td>
                      </tr>
                    <?
                ...
                ?>
                    ...
                    <?
                    // if(!empty($jmlOutliningAllHasil))
                    // {
                    ?>
                      <div class="card shadow-sm">
                        <div class="card-header bg-transparent border-0">
                          <h3 class="mb-0"><i class="far fa-clone pr-1"></i>Informasi Approval Outlining Hasil</h3>
                        </div>
                        <div class="card-body pt-0">
                          <table class="table table-bordered">
                            <tr>
                              ...
                              {
                              ?>
                              <td><?=$jmlBelumOutliningHasil?></td>
                              <?
                              }
                              else
                              {
                              ?>
                              <td><a href="app/index/outlining_assessment_approval?reqVstatus1=0"><?=$jmlBelumOutliningHasil?></a>
                              </td>
                              <?
                              }
                              ?>
                            ...
                            <tr>
                              ...
                              {
                              ?>
                              <td><?=$jmlDraftOutliningHasil?></td>
                              <?
                              }
                              else
                              {
                              ?>
                              <td><a href="app/index/outlining_assessment_approval?reqVstatus1=1"><?=$jmlDraftOutliningHasil?></a>
                              </td>
                              <?
                              }
                              ?>
                            ...
                            <tr>
                              ...
                              {
                              ?>
                              <td><?=$jmlProsesOutliningHasil?></td>
                              <?
                              }
                              else
                              {
                              ?>
                              <td><a href="app/index/outlining_assessment_approval?reqVstatus1=10"><?=$jmlProsesOutliningHasil?></a>
                              </td>
                              <?
                              }
                              ?>
                            ...
                            <tr>
                              ...
                              {
                              ?>
                              <td><?=$jmlReturnOutliningHasil?></td>
                              <?
                              }
                              else
                              {
                              ?>
                              <td><a href="app/index/outlining_assessment_approval?reqVstatus1=30"><?=$jmlReturnOutliningHasil?></a>
                              </td>
                              <?
                              }
                              ?>
                             ...
                             <tr>
                              ...
                              {
                              ?>
                              <td><?=$jmlRejectOutliningHasil?></td>
                              <?
                              }
                              else
                              {
                              ?>
                              <td><a href="app/index/outlining_assessment_approval?reqVstatus1=90"><?=$jmlRejectOutliningHasil?></a>
                              </td>
                              <?
                              }
                              ?>
