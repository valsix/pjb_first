...
$arrtabledata= array(
    ...
    , array("label"=>"fieldid", "field"=> "AREA_ID", "display"=>"1",  "width"=>"", "colspan"=>"", "rowspan"=>"")
);
?>
...
<script type="text/javascript">
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/area_json/json?reqPencarian="+reqPencarian;
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/area_json/json";
