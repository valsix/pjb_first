                        ...
                        <div style="overflow-y: auto;height: 100%;width: 100%;">
                            <table id="" class="table table-bordered table-striped table-hovered" style="width: 100%;" >
                                ...
                                <tr class="distrik">
                                    ...
                                    <th style="background-color:#fdff85;">Distrik</th>
                                ...
                                <table id="page2" class="table table-bordered table-striped table-hovered" style="width: 100%;" >
                                    <tbody >
                                        ...
                                        <tr class="area">
                                            ...
                                            <th style="background-color:#fdff85;">Area</th>
                                    ...
                                    foreach ($arrareadetil as $key => $value) 
                                    {
                                       ...
                                       else
                                       {
                                        ...
                                        <tr class="detil">
                                            ...
                                            <th style="background-color:#fdff85;">Keterangan</th>
                            ...
                            <table id="" class="table table-bordered table-striped table-hovered" style="width: 100%;" >
                                <tbody >
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <select class="easyui-validatebox textbox form-control" name="reqSumberAnggaranId">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="easyui-validatebox textbox form-control" name="reqJenisRekomendasiId">
                                        ...
                                        <td style="background-color:#fdff85;">Status Rekomendasi</td>
                                        <td>
                                            <select class="easyui-validatebox textbox form-control" name="reqStatusRekomendasiId">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="easyui-validatebox textbox form-control" name="reqPrioritasRekomendasiId">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <select class="easyui-validatebox textbox form-control" name="reqKategoriRekomendasiId">
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <select class="easyui-validatebox textbox form-control" name="reqTimelineRekomendasiId">
                                                <option value="">Pilih Timeline Rekomendasi</option>
                                                <?
                                                foreach ($arrtimeline as $keys => $val) 
                                                {
                                                    $selected="";
                                    ...
                                    <tr>
                                        <td style="display: none">
                                            <input class="easyui-validatebox textbox form-control" type="text" name="reqAreaDetilId" id="reqAreaDetilId" value="<?=$reqAreaDetilId?>" style="width: 500px" > 
