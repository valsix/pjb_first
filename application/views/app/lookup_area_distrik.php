...
$arrtabledata= array(
    ...
    , array("label"=>"Nama di Unit", "field"=> "AREA_UNIT", "display"=>"",  "width"=>"", "colspan"=>"", "rowspan"=>"")
...
<div class="col-md-12">
    <div class="judul-halaman"> Data Lookup Area</div>
...
<script type="text/javascript">
    ...
    $('#btnCari').on('click', function () {
        ...
        jsonurl= "json-app/lookup_area_distrik_json/json?reqId=<?=$reqId?>";
    ...
    jQuery(document).ready(function() {
        var jsonurl= "json-app/lookup_area_distrik_json/json?reqId=<?=$reqId?>";
