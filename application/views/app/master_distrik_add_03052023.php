...
<div class="col-md-12" >
    ...
    <div class="judul-halaman"> <a href="iframe/index/<?=$pgreturn?>">Data Distrik/Unit</a> &rsaquo; Kelola Distrik/Unit</div>
            ...
            <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                ...
                <div class="form-group">  
                    ...
                    <div class='col-md-8'>
                        <div class='form-group'>
                            <div class='col-md-11'>
                                 <input autocomplete="off" class="easyui-validatebox textbox form-control edittext" type="text" name="reqKodeSite"  id="reqKodeSite" value="<?=$reqKodeSite?>" <?=$disabled?> data-options="required:true" style="width:100%" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">  
                    <label class="control-label col-md-2">Jenis Pembangkit</label>
                    <div class='col-md-4'>
                        <div class='form-group'>
                            <div class='col-md-11'>
                                <select class="form-control jscaribasicmultiple edittext" id="reqJenisUnitKerjaId" <?=$disabled?> name="reqJenisUnitKerjaId[]" style="width:100%;" multiple >
