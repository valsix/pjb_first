...
<div class="col-md-12" >
  ...
  <div class="judul-halaman"> <a href="app/index/<?=$pgreturn?>">Data Distrik/Unit</a> &rsaquo; Kelola Distrik/Unit</div>
    ...
    <div class="konten-area">
       <!--  <div class="konten-inner"  style="overflow-y: auto;max-height: 450px;" > -->
        <div class="konten-inner" >
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                    <select class="form-control jscaribasicmultiple" id="reqDirektoratId" <?=$disabled?> name="reqDirektoratId"  style="width:100%;" >
                                        <?
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-4'>
                            <div class='form-group'>
                                <div class='col-md-11'>
                                    <select class="form-control jscaribasicmultiple" id="reqJenisUnitKerjaId" <?=$disabled?> name="reqJenisUnitKerjaId[]" style="width:100%;" multiple >
            ...
            <div style="text-align:center;padding:5px">
                ...
                ?>
                    ...
                    <iframe src="app/index/master_blok_unit?reqDistrikId=<?=$reqId?>" width="100%" height="800"></iframe>
