                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-3'>
                                    <select name="reqBulan" id="reqBulan"  readonly class="form-control datatable-input">
                                ...
                                <tbody id="outlinedetil">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <tr id="<?=$reqUniqId?>">
                                                <td> <?=$reqUniqId?></td>
                                               <!--  <td onclick='detilform("<?=$reqId?>","<?=$reqDetilId?>","<?=$reqListAreaId?>","<?=$reqItemAssessmentDuplikatId?>");'> -->
                                                <td >
                                                ...
                                                <td> 
                                                   <!--  <textarea class="easyui-validatebox textbox form-control"  style="width: 340px;" disabled name="reqDeskripsi[]"  id="reqDeskripsi<?=$reqUniqId?>"><? /*=$value["DESKRIPSI"]*/?></textarea> -->
                                                ...
                                                <td  style='white-space: nowrap' >
                                                    ...
                                                    if(!empty($reqAreaDetilId))
                                                    {
                                                        ...
                                                        <!-- <button class="btn btn-danger btn-sm " type="button"  onclick='HapusDetil("<?=$reqDetilId?>","<?=$reqId?>")'>
                                                         ...
                                                         <label style="font-weight: normal !important;">Sudah Terisi</label>
                                                        <?
                                                    }
                                                    ?>
                                                </td>     
