        ...
        <div class="konten-inner">
            ...
            <div>
                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <?
                    $approval_table= "outlining_assessment_area_detil";
                        ...
                        <table id="" class="table table-bordered table-striped table-hovered" style="width: 100%;" >
                            ...
                            <tbody id="outlinedetil">
                                ...
                                {   
                                    ...
                                    $vstatus= $setdetil->getField("V_STATUS");

                                ?>
                                    <tr>
                                        <td style="display: none">
                                            <?=$reqItemAssessmentFormulirId?>
                                            <input class="easyui-validatebox textbox form-control" type="hidden" name="reqItemAssessmentFormulirId[]" id="reqItemAssessmentFormulirId<?=$reqUniqId?>"   value="<?=$reqItemAssessmentFormulirId?>"  >
                                        </td>
                                        <td> <?=$reqUniqId?></td>
                                        <td >
                                            <input class="easyui-validatebox textbox form-control" type="hidden" name="reqItemAssessmentId[]" id="reqItemAssessmentId<?=$reqUniqId?>"   value="<?=$reqItemAssessmentId?>"  >
                                        ...
                                        <td style="vertical-align:middle;"><input type="radio" name="reqConfirm[<?=$reqUniqId?>]" id="reqConfirm<?=$reqUniqId?>" <? if($reqConfirm=="1") echo 'checked';?> value="1"></td>
                                        <td style="vertical-align:middle;"><input type="radio" name="reqConfirm[<?=$reqUniqId?>]" id="reqConfirm<?=$reqUniqId?>" <? if($reqConfirm=="0") echo 'checked';?> value="0"></td>
                                        <td>  
                                        ...
                                        <td  style='white-space: nowrap' >
                                            <input type="file" name="reqFoto[]" id="reqFoto<?=$reqUniqId?>" accept="image/png, image/jpeg" >
                                            <?
                                            if(!empty($reqFoto))
                                            {
                                                ?>
                    ...
                    <a href="javascript:void(0)" class="btn btn-success" onclick="kembali()">Kembali</a>
...
$('#draft,#draft2').click(function() {
    ...
    function AddRekomendasi(reqAreaDetilId,reqDetilId,reqId)
    {
        ...
        window.open('app/index/outlining_assessment_add_rekomendasi?reqAreaDetilId='+reqAreaDetilId+'&reqDetilId='+reqDetilId+'&reqId='+reqId+'&reqKembali=1&reqPage=4', '_self'); 
    } 
