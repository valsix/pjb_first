                ...
                <form id="ff" class="easyui-form form-horizontal" method="post" novalidate enctype="multipart/form-data">
                    ...
                    <div class="form-group">  
                        ...
                        <div class='col-md-8'>
                            <div class='form-group'>
                                <div class='col-md-4'>
                                     <input autocomplete="off" <?=$disabled?>  class="easyui-validatebox textbox form-control" type="text" name="reqUsername"  id="reqUsername" maxlength="10" value="<?=$reqUsername?>"  style="width:100%" <?if($reqUsername){echo "readonly";}?> />
                                </div>
                            </div>
                        </div>
                    </div>
