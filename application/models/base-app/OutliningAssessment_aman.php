...
class OutliningAssessment extends Entity { 
	...
	function insertdetil()
    {
    	...
    	(
    		OUTLINING_ASSESSMENT_DETIL_ID,OUTLINING_ASSESSMENT_ID,LIST_AREA_ID,KATEGORI_ITEM_ASSESSMENT_ID,ITEM_ASSESSMENT_DUPLIKAT_ID,ITEM_ASSESSMENT_FORMULIR_ID,STANDAR_REFERENSI_ID,STATUS_CONFIRM,KETERANGAN,LAST_CREATE_USER,LAST_CREATE_DATE,AREA_UNIT_DETIL_ID
    	)
    	VALUES 
    	(
	...
	function selectByParamsDetil($paramsArray=array(),$limit=-1,$from=-1, $statement='', $sOrder="ORDER BY OUTLINING_ASSESSMENT_ID ASC")
	{
		$str = "
			SELECT 
